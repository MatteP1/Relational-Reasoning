...
\begin{proof}
  ...
  In general, the induction hypothesis will be $\forall \tenv, \venv, \tenv', \venv', \expr, \expr', \typ, \typ' . R(\tenv, \venv, \expr, \expr', \typ) \land \ctx' : (\envstyp \tenv \venv \type \typ \Rightarrow \envstyp {\tenv'} \venv' \type \typ') \implies R(\tenv', \venv', \ctx'[\expr], \ctx'[\expr'], \typ')$, where $\ctx'$ is structurally smaller than $\ctx$.
  \begin{itemize}
    ...
    \item[case] $\ctx = \Fst \ctx'$\\
      Then $\ctx : (\jdgType{\tenv}{\venv}{\typ} \Rightarrow \jdgType{\tenv'}{\venv'}{\typ_1})$ and $\ctx' : (\jdgType{\tenv}{\venv}{\typ} \Rightarrow \jdgType{\tenv'}{\venv'}{\Tprod{\typ_1}{\typ_2}})$, so our goal is $R(\tenv', \venv', \ctx[\expr], \ctx[\expr'], \typ_1)$. By I.H. we get $\jdgRel{\tenv'}{\venv'}{\ctx'[\expr]}{}{\ctx'[\expr']}{\Tprod{\typ_1}{\typ_2}}$, and by cng-fst with this, we get $\jdgRel{\tenv'}{\venv'}{\Fst \ctx'[\expr]}{}{\Fst \ctx'[\expr']}{\Tint} \equiv \jdgRel{\tenv'}{\venv'}{\ctx[\expr]}{}{\ctx[\expr']}{\Tint}$.
...
\begin{mathpar}
  ...
  \and
  \inferrule*[lab=Cng-unit]{ }{ \envscteqgen \tenv \venv \exp1 {\TT} \exp2 {\TT} \type {\Tunit} }
  \and
  \inferrule*[lab=Cng-int]{ }{ \envscteqgen \tenv \venv \exp1 {\Num{n}} \exp2 {\Num{n}} \type {\Tint} }
  \and
  ...
  \inferrule*[lab=Cng-eq]
    ...
    { \envscteqgen \tenv \venv \exp1 {\expr_1 = \expr_2} \exp2 {\expr_1' = \expr_2'} \type {\Tbool} }
  \and
  \inferrule*[lab=Cng-true]{ }{ \envscteqgen \tenv \venv \exp1 {\True} \exp2 {\True} \type {\Tbool} }
  \and
  \inferrule*[lab=Cng-false]{ }{ \envscteqgen \tenv \venv \exp1 {\False} \exp2 {\False} \type {\Tbool} }
  \and
...
\begin{mathpar}
  ...
  \inferrule*[lab=Cng-rec]
    ...
    { \envscteqgen \tenv \venv \exp1 {\Rec f \var := \expr} \exp2 {\Rec f \var := \expr'} \type \Tfunc{\typ_1}{\typ_2} }
  \and
