...
In this report, we defined contextual equivalence on System F, which states that two well-typed expressions should terminate at the same boolean value when plugged into an arbitrary context that takes expressions of their common type, and becomes closed at type boolean. We also showed how we could think of contextual equivalence as the coarsest relation that was adequate, a congruency relation, and wherein all expressions were well-typed.
