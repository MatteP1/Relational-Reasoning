...
\begin{definition}\label{def:CE2}
    \todo{rephrase as: TENV X VENV X EXPR X EXPR X TYPE}
...
\\\todo{How should I phrase this theorem (thm 6)?}
\todo{rephrase as: TENV X VENV X EXPR X EXPR X TYPE}
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item[case] $\ctx = \ctx' + \expr''$\\
      \todo{I'm a bit unsure about how to argue the types of the contexts. Is this fine or is more required? it's fine}
...
\begin{proof}
  ...
  \todo{Would you recommend that I show this case or is it fine just to refer? The proofs would be essentially identical}
\end{proof}
...
\todo{draft}
\\\todo{In general, are the theorems correctly stated?}
