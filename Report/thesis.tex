...
However, a common design-principle worth noting, is that the property of interest is preserved by eliminating forms. This is the part that, when using the LR model in proofs, makes it stronger than the induction hypothesis from a "direct" proof. This design-principle will also be very common in the LR model we define.\\
